...
require (
	...
	github.com/direnv/direnv/v2 v2.30.3
	...
	github.com/grafana/loki v1.6.2-0.20220720081802-b8d260edc046 // https://github.com/grafana/loki/issues/2826#issuecomment-717902042
...
require github.com/vgarvardt/pgx-google-uuid/v5 v5.0.0-alpha.3
...
// Copied from this PR: https://github.com/grafana/loki/pull/6037
// That should have solved it in grafana/loki already but apparently it didn't...
replace k8s.io/client-go => k8s.io/client-go v0.23.6

// More replacements copied from loki's go.mod:
...
// Use fork of scany that works with pgx v5
replace github.com/georgysavva/scany => github.com/dermetfan/scany v1.0.1-0.20220720125230-487954080390 // pgx5
