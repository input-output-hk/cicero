...
require (
	cirello.io/oversight v1.2.0
	cuelang.org/go v0.4.3
	github.com/adrg/xdg v0.4.0
	github.com/alexflint/go-arg v1.4.3
	github.com/antonlindstrom/pgstore v0.0.0-20220421113606-e3a6e3fed12a
	github.com/direnv/direnv/v2 v2.32.2
...
require (
	...
	github.com/thanos-io/thanos v0.30.2 // indirect
...
// Replacements copied from loki's `go.mod`.
// Figured out which are needed by repeatedly trying `go build` and looking at the compilation errors.
// See here for why this is necessary:
// https://github.com/grafana/loki/issues/2826#issuecomment-791431804
replace (
...
// https://github.com/hashicorp/nomad/issues/11826
replace (
...
// taken from nomad's `go.sum` at v1.5.1 due to compilation error
