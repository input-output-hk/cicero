...
func (_m *FactService) GetByFields(_a0 [][]string) ([]*domain.Fact, error) {
	ret := _m.Called(_a0)
...
func (_m *FactService) GetLatestByFields(_a0 [][]string) (domain.Fact, error) {
	ret := _m.Called(_a0)
...
func (_m *FactService) Save(_a0 pgx.Tx, _a1 *domain.Fact) error {
