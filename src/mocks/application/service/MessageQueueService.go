...
func (_m *MessageQueueService) Publish(_a0 string, _a1 domain.StreamName, _a2 []byte, _a3 ...liftbridge.MessageOption) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, domain.StreamName, []byte, ...liftbridge.MessageOption) error); ok {
